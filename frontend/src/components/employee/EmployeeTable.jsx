...
const EmployeeTable = () => {
  ...
  const handleEdit = (employeeId) => {
    ...
    toast.info('Editing employee details');
  };

  const handleHistory = (employeeId) => {
    navigate(`/employees/${employeeId}/history`);
    toast.info('Viewing employee history');
  };

  const handlePayroll = (employeeId) => {
    navigate(`/employees/${employeeId}/payroll-history`);
    toast.info('Viewing employee payroll history');
  };
          ...
          {employees.map((employee) => (
            <tr key={employee.id} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                ...
                <button
                  onClick={() => handleHistory(employee.id)}
